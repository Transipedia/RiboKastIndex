...
ribowaltz_folder <- paste0(local_path, "RESULTS_ALL/riboWaltz.", readsLength_min, "-", readsLength_max, "/")
...
bam_folder <- paste0(local_path,"RESULTS_ALL/BAM_transcriptome.",readsLength_min,"-",readsLength_max,"/")
